...
PARENT_DIR = 'D:\\AV Project\\CFZ-Net'  # Please update to your project's root directory
...
SOURCE_DIR = "D:\\AV Project\\Dataset6x6mm\\" # Please update to your raw data source directory